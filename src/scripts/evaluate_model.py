...
model_path = "../shared/ddos_model.joblib"
model, expected_features = load(model_path)

# === Load the new test dataset ===
new_data_path = "/Users/mariamabidi/Desktop/DDoS-Mitigation/src/data/cleaned/ddos_data2_cleaned.csv"  # <-- change this if your test data is elsewhere
